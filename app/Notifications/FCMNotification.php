...
//            dd($data_string);
                ...
                Log::channel('api')->info('SendNotification INFO: '. json_encode($response->getBody()));
    ...
    public static function SendNotification2($userId, $type, $title, $body, $notifData){
        try{
            if($type == 'app'){
                $user  = FcmTokenApp::where('user_id', $userId)->first();
            }
...
//            dd($data_string);
                ...
                Log::channel('api')->info('SendNotification2 INFO: '. json_encode($response->getBody()));
