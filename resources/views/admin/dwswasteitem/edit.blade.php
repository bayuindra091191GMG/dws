                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group form-float form-group-lg">
                                                        <div class="form-line">
                                                            ...
                                                            <textarea name="description" id="description" class="form-control" rows="10">{{ $item->description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group form-float form-group-lg">
                                                        <div class="form-line">
                                                            ...
                                                            <textarea name="other_description" id="other_description" class="form-control" rows="10">{{ $item->other_description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-line">
                                                            ...
                                                            <select name="category" id="category">
                                                                @foreach($categories as $category)
                                                                    @if($category->id == $item->dws_waste_category_datas_id)
