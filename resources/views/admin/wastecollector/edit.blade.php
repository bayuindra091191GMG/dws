                                    ...
                                    <div class="tab-pane animated fadeInUpShort show active" id="v-pills-1">
                                        ...
                                        <div class="body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group form-float form-group-lg">
                                                    <div class="form-line">
                                                        <label class="form-label" for="wastebank">Pengolahan Sampah *</label>
                                                        <select id="wastebank" name="wastebank" class="form-control">
                                                            <option value="-1" @if($wasteBankId == -1) selected @endif> - Pilih Pengolahan Sampah - </option>
                                        ...
                                        <div class="col-md-11 col-sm-11 col-xs-12" style="margin: 3% 0 3% 0;">
                                            <a href="{{ route('admin.wastecollectors.show', ['id' => $wasteCollector->id]) }}" class="btn btn-danger">BATAL</a>
