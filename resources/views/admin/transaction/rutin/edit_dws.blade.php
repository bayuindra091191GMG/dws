...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-body">
                <h2 class="card-title m-b-0">Ubah Transaksi Penjemputan Rutin Kategori DWS</h2>
                            ...
                            <div class="card">
                                <div class="card-body b-b">
                                    ...
                                    <div class="col-md-11 col-sm-11 col-xs-12">
                                        <a href="{{ route('admin.transactions.penjemputan_rutin.show', ['id' => $header->id]) }}" class="btn btn-danger">KEMBALI</a>
