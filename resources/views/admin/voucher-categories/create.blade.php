...
<div class="row">
    <div class="col-12">
        <div class="card-body">
            <h2 class="card-title m-b-0">Tambah Baru Kategori Voucher</h2>

            {{ Form::open(['route'=>['admin.voucher-categories.store'],'method' => 'post','id' => 'general-form', 'enctype' => 'multipart/form-data']) }}
