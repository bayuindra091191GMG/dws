    ...
    <div class="row">
        <div class="col-12">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h3>UBAH DATA PENGOLAHAN SAMPAH KATEGORI MASARO</h3>
                    </div>
                </div>
                                        ...
                                        <div class="body">
                                            <div class="col-md-12">
                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#basic" role="tab" aria-controls="home" aria-selected="true">INFORMASI</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#schedule" role="tab" aria-controls="profile" aria-selected="false">JADWAL</a>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    <div class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="basic-tab">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group form-float form-group-lg">
                                                                <div class="form-line">
                                                                    <label class="form-label" for="senin">Hari Buka</label>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group form-float form-group-lg">
                                                                <div class="form-line">
                                                                    <label class="form-label" for="closed_hours">Jam Tutup</label>
    ...
    <script type="text/javascript">
        ...
        $("#add_row").click(function(){
            $('#sch'+i).html("<td class='field-item'>" +
                "<input type='hidden' name='schDetailId[]' value='-1'>" +
                "<select class='form-control' id='schDay" + i + "' name='schDays[]'>" +
                "<option value='1'>Senin</option>" +
                "<option value='2'>Selasa</option>" +
                "<option value='3'>Rabu</option>" +
                "<option value='4'>Kamis</option>" +
